...
export const TILE_DATA: Record<string, TileInfo> = {
  ...
  A1: { id: "A1", suit: "circles", hanzi: "筒", num: 1, icon: "🛡", label: "Guard Info", tip: "Guard your personal info", example: "Never share your NRIC, OTP or bank login — real agencies will never ask for them.", type: "shield" },
  ...
  A9: { id: "A9", suit: "circles", hanzi: "筒", num: 9, icon: "⚠", label: "Not Real", tip: "Guaranteed returns = fake", example: "No real investment guarantees profit — 'guaranteed returns' means scam.", type: "shield" },
  ...
  B3: { id: "B3", suit: "bamboo", hanzi: "條", num: 3, icon: "😴", label: "Wait", tip: "Sleep on it", example: "Sleep on it — a genuine offer won't disappear if you take a day to check.", type: "shield" },
  B4: { id: "B4", suit: "bamboo", hanzi: "條", num: 4, icon: "🎰", label: '"Win"', tip: "Fake lottery win", example: "'Congratulations! You've won $5,000 — pay a small fee to release it.'", type: "redflag" },
  ...
  B8: { id: "B8", suit: "bamboo", hanzi: "條", num: 8, icon: "🤐", label: "Secret?", tip: '"Don\'t tell anyone"', example: "'Don't tell your family about this — keep it our little secret.'", type: "redflag" },
  B9: { id: "B9", suit: "bamboo", hanzi: "條", num: 9, icon: "📢", label: "Tell", tip: "Tell someone you trust", example: "Tell someone you trust before acting — they may spot the trick you missed.", type: "shield" },
  ...
  WS: { id: "WS", suit: "wind", hanzi: "南", num: null, icon: "🎣", label: "Phish", tip: "Phishing bait", example: "A text with a link: 'Update your bank details here' — leading to a fake site.", type: "redflag" },
