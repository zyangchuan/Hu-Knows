...
// Ported verbatim from frontend/lib/rules.ts — the reference implementation.
// See GAME_MECHANIC_BRIEF.md §3–4.
...
export function getLegalClaims(
  ...
  // (brief §4: the original reference hardcoded meldCount=0 — a melded claimer
  // was never offered a winning HU). Pass the seat's real meldCount.
